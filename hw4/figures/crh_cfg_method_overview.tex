...
\begin{tikzpicture}[
  ...
  flow/.style={-{Latex[length=2.5mm,width=1.7mm]},line width=0.75pt,draw=black},
...
\node[sagebox,text width=1.84cm,minimum height=2.65cm] (affine) at (9.28,9.18) {
...
\node[periwinklebox,text width=1.25cm,minimum height=2.65cm] (score) at (13.38,9.18) {
  {\fontsize{10.2}{11.4}\selectfont Batched}\\[-0.3mm]
  $F_{\mathrm{ctrl}}$\\[-0.3mm]
  {\fontsize{10.2}{11.4}\selectfont Scoring}
};

\node[rosebox,text width=1.72cm,minimum height=2.65cm] (margin) at (15.38,9.18) {
...
\node[coralbox,text width=1.51cm,minimum height=2.65cm] (filter) at (17.70,9.18) {
